...
Use this page to explain the structural responsibilities and implementation constraints of this module. cli in Luna-Flow/mooncake_impact_factor.

## Responsibilities

- Keep the code and docs aligned around `src/cli`.
