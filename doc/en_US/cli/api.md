...
cli is part of Luna-Flow/mooncake_impact_factor. This page should describe the public types, constructors, functions, traits, and observable semantics that are implemented in the current branch.

## Scope

- Source boundary: `src/cli`
